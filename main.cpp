...
void start() {
    Object* objects[] = {
        ...
        new Sphere{{ 560, 400, 80 }, { 1.0, 1.0, 1.0 },     50,     { 0.9, 5.0, 0.0, 1.0  }}, //гладкий
        new Sphere{{ 600, 385, 10 }, { 1.0, 0.0, 0.0 },     30,     { 0.9, 5.0, 0.0, 1.0  }}, //гладкий
        new Sphere{{ 400, 400, 100}, { 1.0, 1.0, 1.0 },     50,     { 0.9, 5.0, 0.0, 0.0  }}, //матовый
        new Plane {{ 0  , 450, 0  }, { 1.0, 1.0, 0.0 }, { 0,-1, 0}, { 0.9, 5.0, 0.0, 0.1  }},
        new Sphere{{ 300, 200,-200}, { 0.9, 0.9, 0.9 },     200  ,  { 0.0, 0.0,-1.0, 0.0  }}  //источник
    };
