//=================================================================================================================
//           [These sections are for folding control  in Code::Blocks]         [$Date: 2021-03-12 02:55:48 +0400 $]
...
//!
//!          $Version: 00173a, Revision: 169 $
//!          $Copyright: (C) Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru> $
//!          $Date: 2021-03-12 02:55:48 +0400 $
//!
...
#define _TX_VER      _TX_v_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 169, 2021-03-12 02:55:48 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
#define _TX_VERSION  _TX_V_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 169, 2021-03-12 02:55:48 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
#define _TX_AUTHOR   _TX_A_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 169, 2021-03-12 02:55:48 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
...
//!          @tr Для компиляторов @c g++ (MinGW, Cygwin) и @c clang
//!          @td -- Указав компилятору ключ @c -mwindows и убрав ключ @c -mconsole.
//!          @tr Для компиляторов Microsoft Visual Studio
...
int                            _txInitialized              = (_TX_NOINIT)? 0 : _txInitialize();
...
//???   case WM_KEYUP:          {$     _txCanvas_OnKEY        (wnd, wpar, lpar, false); return 0; }
//???   case WM_KEYDOWN:        {$     _txCanvas_OnKEY        (wnd, wpar, lpar, true);  return 0; }
